...
/**
 * merge_sort_recursive - impllements merge sort algo throufh recursion
 * @subarr: subarray of an array of int to sort
...
/**
 * merge_sort - sorts array of int in ascending order
 * @array: array of integers
 * @size: size of array
 *
 * Description: implements top-down sort algorithm
 */
void merge_sort(int *array, size_t size)
{
	int *buff;
